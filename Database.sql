...
INSERT INTO dbo.[ROLE] (ID,NAME,IS_DELETED,CREATE_BY,CREATE_DATE,UPDATE_BY,UPDATE_DATE) VALUES
	 (N'ADM',N'Admin',0,N'SYSTEM',getdate(),N'SYSTEM',getdate()),
	 (N'MBR',N'Member',0,N'SYSTEM',getdate(),N'SYSTEM',getdate());

INSERT INTO dbo.[USER] (ID,USERNAME,PASSWORD,FULLNAME,MAIL,PHONE_NUMBER,TOKEN,IS_LOCKOUT,ACCESS_FAILED_COUNT,IS_DELETED,CREATE_BY,CREATE_DATE,UPDATE_BY,UPDATE_DATE) VALUES
	 (N'491874CE-92C0-4CFD-83B7-F916DF7C219B',N'Admin',N'5F4DCC3B5AA765D61D8327DEB882CF99',N'Administrator',N'admin@mail.com',N'0000000',null,0,0,0,N'SYSTEM',getdate(),N'SYSTEM',getdate());
